...
**cf-gears-resource-group** (302 tests):
...
**cf-gears-resource-group-sdk** (16 tests):
...
- [x] All ~325 unit tests pass (`cargo test -p cf-gears-resource-group -p cf-gears-resource-group-sdk`) — 325 tests, 0 failed (as of 2026-03-29)
