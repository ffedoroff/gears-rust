...
`gears/system/account-management/docs/features/feature-{slug}.md` (for the 8
parent features) or
`gears/system/account-management/docs/tr-plugin/features/feature-{slug}.md`
